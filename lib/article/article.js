...
var ArticleXmlImporter = require('./converter/article_xml_importer');
...
Article.fromXml = function(xml) {
  ...
  var doc = new Article();
  new ArticleXmlImporter().convert($root, doc);
  doc.documentDidLoad();
  return doc;
};

Article.ArticleHtmlImporter = ArticleHtmlImporter;
Article.ArticleXmlImporter = ArticleXmlImporter;

Article.ARTICLE_XML_TEMPLATE =[
